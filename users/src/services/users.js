  ...
  fastify.delete(
    '/:id', 
    {
      schema: {
        ...
        params: S.object().prop('id', S.string().description("The user id to delete").required()),
        response: {
          200: S.ref('#message'),
          404: S.ref('#message')
        }
  ...
  fastify.post(
    '/',
    {
      schema: {
        ...
        body: S.object().prop('username', S.string().maxLength(10).description("The preferred username").required())
                        .prop('password', S.string().description("The password") .required())
                        .prop('fullName', S.string().maxLength(50).description("The name of the user").required())
                        .prop('profile',  S.string().maxLength(50).description("The name of the user").required()),
        response: {
          200: S.object()
                  .prop('username', S.string())
                  .prop('fullName', S.string())
